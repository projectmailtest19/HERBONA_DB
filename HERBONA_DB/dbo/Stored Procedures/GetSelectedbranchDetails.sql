-- [GetSelectedbranchDetails] 2
CREATE procedure [dbo].[GetSelectedbranchDetails] 
@ID int = null
AS
BEGIN
	...
	st.ID as State, City,addr.addressline as  Address, LogoPath, c.IsActive from [branch] as c
