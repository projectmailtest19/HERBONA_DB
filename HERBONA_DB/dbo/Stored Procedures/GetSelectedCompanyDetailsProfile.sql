CREATE procedure [dbo].[GetSelectedCompanyDetailsProfile] 
@ID int = null
...
select c.ID, CompanyName, CEOName, MobileNo, PhoneNo, Email,cnt.ID as  Country, 
	st.ID as State, City, CompanyType,addr.addressline as   Address, WebsiteUrl, LogoPath, c.IsActive,c.Contact_ID,
	[CIN]
      ,[PAN]
      ,[GST_NUMBER] from company as c
