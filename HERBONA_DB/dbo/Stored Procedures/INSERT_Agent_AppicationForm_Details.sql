create procedure [dbo].[INSERT_Agent_AppicationForm_Details]
@Contact_id		int=null,
...
IF( @MODE = 'INSERT' ) 
  BEGIN 
      ...
      INSERT INTO [Agent_AppicationForm_Details] 
                  ([Contact_id]
      ,AppicationForm_URL
      ,[IsActive]
      ,[CreatedDate]
      ...
      SELECT @@IDENTITY                      AS ID, 
             'Application Form Successfully Uploaded' AS CustomMessage, 
...
IF(@MODE = 'UPDATE' ) 
  BEGIN 
      ...
      UPDATE [Agent_AppicationForm_Details] 
      SET    AppicationForm_URL = @AppicationForm_URL, 
             updateddate = Getdate(), 
      ...
      SELECT id                            AS ID, 
             'Application Form Successfully Uploaded' AS CustomMessage, 
             '0'                            AS CustomErrorState from [Agent_AppicationForm_Details] where [Contact_id] = @Contact_ID 
