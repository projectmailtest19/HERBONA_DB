CREATE procedure [dbo].[INSERT_Agent_BankProof_Details]
@UDT_Agent_BankProof_Details UDT_Agent_BankProof_Details READONLY,
...
MERGE Agent_BankProof_Details AS T
USING (
SELECT [id],
	   [Contact_id],
	   [Bank_Proof_Type],
	   [Bank_Proof_URL] 
  FROM @UDT_Agent_BankProof_Details
) AS S
...
WHEN MATCHED THEN 
     UPDATE SET
      ...
      ,T.[Bank_Proof_Type]=S.[Bank_Proof_Type]  
	  ,T.[Bank_Proof_URL]=S.[Bank_Proof_URL]  
